...
class Visas extends Component {
  ...
  handleUpdate = type => {
    return this.props.history.replace("/visas-accounts/" + type.id + "/edit");
  };
  ...
  handleOnDetail = type => {
    return this.props.history.replace("/visas-accounts/view/" + type.id);
  };
          ...
          <div>
            <center>
              ...
              <div>
                ...
                <Link to="/visas-accounts/new" className="ui primary button">
                  New Account
                </Link>
              </div>
            </center>
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <Confirm
          ...
          size="mini"
        />
        <TableTitle title="Visas Accounts" icon="tag" />
