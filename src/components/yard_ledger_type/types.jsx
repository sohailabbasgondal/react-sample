...
class YardTypes extends Component {
  state = {
    open: false,
    type: "",
    types: [],
  ...
  handleUpdate = type => {
    return this.props.history.replace(
      "/yards-ledgers-types/" + type.id + "/edit"
    );
  };
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <Confirm
          ...
          size="mini"
        />
        <TableTitle title="Yards ledger types" icon="tag" />
