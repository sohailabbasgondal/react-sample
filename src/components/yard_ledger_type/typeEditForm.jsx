...
import {
  getLedgerType,
  updateLedgerType
} from "../../services/yardLedgerTypeService";
...
class YardTypeEditForm extends Form {
  state = {
    data: {
      name: ""
    },
  ...
  doSubmit = async () => {
    try {
      ...
      this.props.history.push("/yards-ledgers-types");
    } catch (ex) {
  ...
  render() {
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <TableTitle title="Update yard ledger type" icon="tag" />
        <center>
          <form
...
export default YardTypeEditForm;
