...
import {
  getLedgerType,
  updateLedgerType
} from "../../services/visaLedgerTypeService";
...
class VisaTypeEditForm extends Form {
  state = {
    data: {
      name: ""
    },
  ...
  doSubmit = async () => {
    try {
      ...
      this.props.history.push("/visas-ledgers-types");
    } catch (ex) {
  ...
  render() {
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <TableTitle title="Update visa ledger type" icon="tag" />
        <center>
          <form
...
export default VisaTypeEditForm;
