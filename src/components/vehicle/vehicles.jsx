...
class Vehicles extends Component {
  ...
  handleUpdate = type => {
    return this.props.history.replace(
      "/vehicles-accounts/" + type.id + "/edit"
    );
  };
  ...
  handleOnDetail = type => {
    return this.props.history.replace("/vehicles-accounts/view/" + type.id);
  };
          ...
          <div>
            <center>
              ...
              <div>
                ...
                <Link to="/vehicles-accounts/new" className="ui primary button">
                  New Account
                </Link>
              </div>
            </center>
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <Confirm
          ...
          size="mini"
        />
        <TableTitle title="Vehicles Accounts" icon="tag" />
