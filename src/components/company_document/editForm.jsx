...
import { getSingle, updateSingle } from "../../services/companyDocumentService";
...
class CompanyDocumentEditForm extends Form {
  state = {
    imageUrl: false,
  ...
  render() {
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <TableTitle title="Update company document" icon="tag" />
        <center>
          <form
...
export default CompanyDocumentEditForm;
