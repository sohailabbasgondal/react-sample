...
import { getAll, deleteSingle } from "../../services/bankService";
...
class Banks extends Component {
  ...
  handleUpdate = type => {
    return this.props.history.replace("/banks-accounts/" + type.id + "/edit");
  };
          ...
          <div>
            <center>
              ...
              <div>
                ...
                <Link to="/banks-accounts/new" className="ui primary button">
                  New Account
                </Link>
              </div>
            </center>
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <Confirm
          ...
          size="mini"
        />
        <TableTitle title="Banks Accounts" icon="tag" />
