...
class Rooms extends Component {
  ...
  handleUpdate = type => {
    return this.props.history.replace("/rooms-accounts/" + type.id + "/edit");
  };
  ...
  handleOnDetail = type => {
    return this.props.history.replace("/rooms-accounts/view/" + type.id);
  };
          ...
          <div>
            <center>
              ...
              <div>
                ...
                <Link to="/rooms-accounts/new" className="ui primary button">
                  New Account
                </Link>
              </div>
            </center>
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <Confirm
          ...
          size="mini"
        />
        <TableTitle title="Rooms Accounts" icon="tag" />
