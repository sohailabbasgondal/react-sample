...
import { getLedger, updateSingle } from "../../services/roomLedgerService";
...
class RoomLedgerEditForm extends Form {
  state = {
    imageUrl: false,
  ...
  async populateLedger() {
    try {
      ...
      this.setState({
        ...
        ledgerType: ledger.room_ledger_type.id,
        data: {
  ...
  doSubmit = async () => {
    try {
      ...
      this.props.history.push("/rooms-accounts/view/" + visaId);
    } catch (ex) {
  ...
  render() {
    ...
    return (
      <BlockUi tag="div" blocking={this.state.blocking}>
        <TableTitle title="Update room ledger" icon="tag" />
        <center>
          <form
              ...
              <Table.Body>
                ...
                <Table.Row>
                  <Table.Cell>
                    ...
                    <Link
                      to={`/rooms-accounts/view/${this.props.match.params.id}`}
...
export default RoomLedgerEditForm;
